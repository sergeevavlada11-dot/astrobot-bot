   ...
   # -----------------------
    ...
    if sphere == "🧬 Личность":
        prompt = (
            ...
            "Твоя задача — подготовить развёрнутую, детализированную консультацию по выбранной сфере жизни, как на личной консультации.\n\n"
            "📌 Формат и стиль:\n"
    ...
    prompt = (
        ...
        "Он должен быть индивидуальным, логичным и стратегическим, как если бы это была консультация опытного астролога по развитию карьеры."
    )
