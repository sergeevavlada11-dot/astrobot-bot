...
async def final_generate(message: types.Message):
    ...
    if sphere == "🧬 Личность":
        prompt = (
            ...
            "Задача: Сформируй глубокий разбор, основываясь на реальных положениях планет, асценденте, куспидах домов и управителях. "
            "Каждый пункт должен содержать конкретные астрологические указания и их интерпретацию."
        )
